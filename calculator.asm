...
;it defines where the machine code is to place in memory

org 100h ;origin directive 
...
msg5 db  0dh,0ah ,'Done! Press any key to return ', 0Dh,0Ah, '$'
